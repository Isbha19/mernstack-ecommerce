          ...
          {!currentCoupon?.isExpired && (
            <div className="bg-yellow-600">
              <div className="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                >
                  {currentCoupon
                    ? `${currentCoupon?.code} - ${currentCoupon?.discount}% OFF ON ALL PRODUCTS, GRAB THE OFFER NOW!! ${currentCoupon?.daysLeft}`
                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="flex flex-1 items-center justify-end">
                    {user?.userFound?.isAdmin && (
                      <Link
                        to="/admin"
                        className="bg-red-500 hover:bg-red-600 text-white font-bold text-sm py-2 px-4 rounded md:py-3 md:px-6 lg:py-4 lg:px-8"
                      >
                        Admin Dashboard
                      </Link>
                    )}
