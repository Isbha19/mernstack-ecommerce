...
import { fetchCouponAction } from "../../../redux/slices/coupons/couponSlices";
...
export default function ShoppingCart() {
  ...
  if (coupon) {
    ...
    sumTotalPrice = (sumTotalPrice - (sumTotalPrice * discount) / 100).toFixed(
      2
    );
  }
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              {isAdded && (
                <SuccessMsg
                  message={`Congrats! You have got ${coupon?.discount}% discount on your order`}
                />
              )}
